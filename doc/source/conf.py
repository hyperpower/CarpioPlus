...
pygments_style = None
# Figure Number
# If true, figures, tables and code-blocks are automatically numbered if they has caption. For now, it works only with the HTML builder. Default is False.
numfig = True
...
latex_documents = [
    (master_doc, 'Carpio.tex', 'Carpio Documentation',
     'Chengsi Zhou', 'manual'),
]
...
man_pages = [
    (master_doc, 'carpio', 'Carpio Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Carpio', 'Carpio Documentation',
     author, 'Carpio', 'One line description of project.',
     'Miscellaneous'),
]
